        ...
        <>
            <div className="player-container">
                <div className="controls">
                    <button className="control-btn"><FaFastBackward className="button-iconn" /></button>
                    <button className="control-btn"><IoMdPlay className="button-iconn" size={"35px"} /></button>
                    <button className="control-btn"><FaFastForward className="button-iconn" /></button>
                </div>
                ...
                <div className="extra-controls">
                    <label className="slider">
                        ...
                        <svg className="volume" xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 24 24"  >
                            <g>
